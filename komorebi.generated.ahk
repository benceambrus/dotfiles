...
; AltServer
RunWait('komorebic.exe float-rule exe "AltServer.exe", , "Hide"')
...
; TotalCommander File Action Windows
RunWait('komorebic.exe float-rule class "TDLG2FILEACTIONMIN"', , "Hide")
